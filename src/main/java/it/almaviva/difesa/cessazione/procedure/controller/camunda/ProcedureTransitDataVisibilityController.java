...
@RestController
@RequestMapping(Constant.PROCEDURE_TRANSIT_DATA_DECISION_INDEX_URL)
@Slf4j
@Validated
@RequiredArgsConstructor
public class ProcedureTransitDataVisibilityController {
    ...
    public List<Map<String, CamundaOutputVariable>> getProcedureTransitDataVisibility(@Valid @RequestBody Map<String, CamundaVariable> variables) {
        return camundaService.getProcedureTransitDataVisibility(variables);
    }
