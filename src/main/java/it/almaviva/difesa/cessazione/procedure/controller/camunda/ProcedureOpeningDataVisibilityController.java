...
@RestController
@RequestMapping(Constant.PROCEDURE_OPENING_DATA_VISIBILITY_INDEX_URL)
@Slf4j
@Validated
@RequiredArgsConstructor
public class ProcedureOpeningDataVisibilityController {
    ...
    public List<Map<String, CamundaOutputVariable>> getProcedureOpeningDataVisibility(@Valid @RequestBody Map<String, CamundaVariable> variables) {
        return camundaService.getProcedureOpeningDataVisibility(variables);
    }
